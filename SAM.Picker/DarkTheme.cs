...
namespace SAM.Picker
{
    ...
    {
        // All colors delegated to shared DarkPalette
        public static Color DarkBackground => DarkPalette.DarkBackground;
        public static Color Surface => DarkPalette.Surface;
        public static Color Toolbar => DarkPalette.Toolbar;
        public static Color Accent => DarkPalette.Accent;
        public static Color AccentSecondary => DarkPalette.AccentSecondary;
        public static Color AccentWarning => DarkPalette.AccentWarning;
        public static Color AccentDanger => DarkPalette.AccentDanger;
        public static Color Text => DarkPalette.Text;
        public static Color TextSecondary => DarkPalette.TextSecondary;
        public static Color TextMuted => DarkPalette.TextMuted;
        public static Color Border => DarkPalette.Border;
        public static Color Hover => DarkPalette.Hover;
        public static Color Pressed => DarkPalette.Pressed;
        public static Color StatusBar => DarkPalette.StatusBar;
        public static Color Selection => DarkPalette.Selection;
        public static Color CardBackground => DarkPalette.Toolbar;
        public static Color DangerBackground => DarkPalette.DangerBackground;
        public static Color DangerSurface => DarkPalette.DangerSurface;
        public static Color DangerText => DarkPalette.DangerText;
        public static Color ProtectedText => DarkPalette.ProtectedText;
